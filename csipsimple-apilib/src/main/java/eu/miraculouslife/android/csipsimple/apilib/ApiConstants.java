...
public class ApiConstants {
    ...
    public static final int API_RESPONSE_TYPE_INCOMING_CALL = 310;
    ...
    public static final String CALL_INCOMING_CALLEE_INTENT_KEY = "call.incoming.callee_name.intent.key";
